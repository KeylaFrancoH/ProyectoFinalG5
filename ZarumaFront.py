...
print(datosGananciasxJugador("topGanancias.csv"))
print(datosGananciasxJuegos("topGananciasxJuegos.csv"))
print(topPaises("toppaises.csv"))
...
class App(tk.Tk):
    ...
    def __init__(self):
        ...
        # prepare data
        jugador, ganancia = datosGananciasxJugador("topGanancias.csv")
        juegos, recaudacion = datosGananciasxJuegos("topGananciasxJuegos.csv")
        paises, cantidad = topPaises("toppaises.csv")
        # create a figure
